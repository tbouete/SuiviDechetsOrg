...
public class ElementPlatSurgele extends Element {

	protected ElementPlatSurgele(double quantity, boolean qtIsQuotient, boolean isBio, boolean isFromOwnGarden) {
		super(quantity, qtIsQuotient, isBio, isFromOwnGarden);
		this.setBasicName("Plat surgelé");

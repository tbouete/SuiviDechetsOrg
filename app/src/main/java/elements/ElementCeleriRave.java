...
public class ElementCeleriRave extends Element {

	protected ElementCeleriRave(double quantity, boolean qtIsQuotient, boolean isBio, boolean isFromOwnGarden) {
		super(quantity, qtIsQuotient, isBio, isFromOwnGarden);
		this.setBasicName("Céleri rave");

...
public class ElementSauceTomate extends Element {

	protected ElementSauceTomate(double quantity, boolean qtIsQuotient, boolean isBio, boolean isFromOwnGarden) {
		super(quantity, qtIsQuotient, isBio, isFromOwnGarden);
		this.setBasicName("Sauce Tomate");

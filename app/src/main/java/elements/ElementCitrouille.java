...
public class ElementCitrouille extends Element {

	protected ElementCitrouille(double quantity, boolean qtIsQuotient, boolean isBio, boolean isFromOwnGarden) {
		super(quantity, qtIsQuotient, isBio, isFromOwnGarden);
		this.setBasicName("Citrouille");
